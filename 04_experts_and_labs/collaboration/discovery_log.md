Path E — Discovery Log

2026-08-19 — Section 01

Search Lane

Global Direct-Fit Science

Search Focus

TMR laboratories and active memory-reactivation groups

closed-loop sleep stimulation and event-aware sleep intervention

sleep-memory EEG / PSG groups with direct experimental relevance

Research Limits Used

3 controlled search passes

target: 12–15 strong opportunities

final count: 15 opportunities

no qualification, priority ranking, or outreach research performed

Sources Explored

official university and institute laboratory pages

current faculty/research-group profiles

official research/project pages

current institutional publication/project records used only to confirm direct scientific fit

Opportunities Added

OPP-001 — Northwestern Cognitive Neuroscience Laboratory

OPP-002 — Oxford Memory and Sleep Group

OPP-003 — UC Irvine Cognitive Neuroscience of Sleep Lab

OPP-004 — Cardiff NaPS / CUBRIC Sleep Research

OPP-005 — University of Fribourg Cognitive Biopsychology and Methods

OPP-006 — Paris Brain Institute DreamTeam

OPP-007 — Tübingen Medical Psychology / Sleep & Memory

OPP-008 — University of York Sleep / Memory Reactivation Research

OPP-009 — LMU Thomas Schreiner Memory Consolidation Group

OPP-010 — HKU Social & Cognitive Neuroscience Laboratory

OPP-011 — ITBA Sleep and Memory Laboratory

OPP-012 — University of Pennsylvania Schapiro Lab

OPP-013 — Baylor Sleep Neuroscience & Cognition Laboratory

OPP-014 — Hong-Viet V. Ngo-Dehning / University of Essex

OPP-015 — NUS Centre for Sleep and Cognition

Interesting Patterns

The strongest direct-fit landscape clusters around TMR, sleep-memory electrophysiology, closed-loop stimulation, and memory-reactivation decoding.

Several Path A experts also represent genuine Path E collaboration opportunities; this cross-track overlap is scientifically useful rather than duplicative.

A subset of groups already combines sleep neuroscience with engineering-relevant methods such as real-time classification, machine learning, event detection, or closed-loop acoustic stimulation.

Geographic coverage is strongest in North America and Europe, with important direct-fit nodes in Hong Kong, Singapore, and Argentina.

New Search Directions

Section 02 should deliberately move beyond direct TMR groups into adjacent capability: real-time EEG/BCI, wearable electrophysiology, arousal detection, causal biosignal classification, and closed-loop control.

Potential secondary leads identified but not added because of the Section 01 cap include broader sleep-memory/replay groups and within-sleep stimulation groups that fit Section 02 better.

2026-08-19 — Section 02

Search Lane

Global Adjacent Scientific Capability

Search Focus

real-time EEG / BCI and online neural decoding

wearable, sparse-channel, ear-EEG, and mobile electrophysiology

causal sleep-state estimation and closed-loop control

multimodal physiological sensing and arousal/sleep monitoring

bioelectronics and future low-burden neural sensing
...
official university and research-center pages

official laboratory/project pages

institutional descriptions of EEG, BCI, wearable sensing, sleep staging, and closed-loop research

project pages used to confirm specific adjacent capabilities rather than direct TMR topic overlap

Opportunities Added

OPP-016 — UC San Diego Swartz Center for Computational Neuroscience (SCCN)

OPP-017 — TU Berlin Chair of Neurotechnology / Berlin BCI

OPP-018 — EPFL Translational Neural Engineering Laboratory

OPP-019 — Aarhus University Center for Ear-EEG / Neurotechnology Group

OPP-020 — ETH Zurich SleepLoopFM / Sensory-Motor Systems Lab

OPP-021 — Stanford Sleep Medicine Computational & Sensing Ecosystem

OPP-022 — Georgia Tech WISH Center / W. Hong Yeo

OPP-023 — UT Austin Nanshu Lu Research Group

OPP-024 — Northwestern Querrey Simpson Institute for Bioelectronics / John Rogers

OPP-025 — Imperial College London In-Ear Physiological Sensing / Danilo Mandic

OPP-026 — University of Surrey Sleep Research Centre

OPP-027 — University of Cambridge Bioelectronics Laboratory

OPP-028 — Wisconsin Institute for Sleep and Consciousness

OPP-029 — University of Oldenburg Mobile EEG / Stefan Debener ecosystem

OPP-030 — University of Freiburg BrainLinks-BrainTools

Interesting Patterns

Section 02 naturally separates into three technical layers: sensing, decoding, and closed-loop control.

Several strong opportunities address sparse, ear-based, or wearable EEG, which may become important for later-generation Neuro-TMR even though EEG-based V1 remains the current reference path.

Real-time sleep-state inference is already being studied outside TMR, especially in projects such as ETH Zurich's SleepLoopFM; this creates a valuable capability bridge for Path V.

Bioelectronics groups extend the opportunity universe beyond software and sleep science into future long-duration, low-burden neural interfaces.

The strongest adjacent opportunities are not necessarily sleep-memory groups; their value comes from solving a specific technical bottleneck that Neuro-TMR will eventually face.

New Search Directions

Section 03 should shift geographically and practically toward the Armenian Scientific Ecosystem, looking for neuroscience, neurophysiology, EEG/PSG, sleep medicine, biomedical engineering, signal processing, clinical infrastructure, and realistic local mentorship/access.
