...
| -------- | ---------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- | ---------- | ------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| OPP-064  | National Sleep Research Resource (NSRR)                                | NSRR account verified; SHHS Standard Individual DAUA prepared and saved through the signature stage; Human Research Protection foundational training completed; signing-eligibility clarification sent to NSRR | NSRR portal + Email        | 2026-08-31 | IN_PROGRESS  | Await NSRR guidance on the correct SHHS DAUA signing route. Continue Pre-Path V execution with OPP-015 in parallel. If permitted, complete SHHS and then open separate STAGES DAUA | Trigger: NSRR support reply; parallel target: OPP-015    | SHHS + STAGES remain the selected NSRR resources; MESA remains reserve. SHHS is not yet signed/submitted and STAGES has not yet been opened. No NSRR raw data has been downloaded and the Download Token remains unused. Human Research Protection completion records are stored privately and must not be committed to Git.                                                                           |
